...
namespace atividade_2_marlao
{
    class conversor
    {
        ...
        public conversor(double x)
        {
            ...
            if(a == "quilometro" ^ a == "Quilometro")
            {

                Quilometro = x;
            }
            else if( a == "Metro" ^ a == "metro")
            {

                Metro = x;
            }
            else if(a == "Centimetro" ^ a == "centimetro")
            {

                Centimetro = x;
            }
            else if(a == "Milimetro" ^ a == "milimetro")
            {

                Milimetro = x;
            }
            else if(a == "Micrometro" ^ a == "micrometro")
            {

                Micrometro = x;
            }
            else if (a == "Nanometro" ^ a == "nanometro")
            {

                Nanometro = x;
            }
            else if(a == "Milha" ^ a == "milha")
            {

                Milha = x;

            }
            else if (a == "Jarda" ^ a == "jarda")
            {
            ...
            else if (a == "Polegada" ^ a == "polegada")
            {


                Polegada = x;
            }
            else if (a == "Milhanautica" ^ a == "milhanautica"^ a == "milha nautica" ^ a == "Milha nautica")
            {
